...
export type LayoutSiteMetadataQueryVariables = Exact<{ [key: string]: never; }>;


export type LayoutSiteMetadataQuery = (
  { __typename?: 'Query' }
  & { site: Maybe<(
    { __typename?: 'Site' }
    & { siteMetadata: Maybe<(
